...
$(document).ready(function() {
	...
	$("#submitBrandForm").unbind('submit').bind('submit', function() {
		...
		if(brandCode == "") {
			$("#brandCode").after('<p class="text-danger">Group field is required</p>');
		...
		if(brandName == "") {
			$("#brandName").after('<p class="text-danger">Group field is required</p>');
		...
		if(brandStatus == "") {
			$("#brandStatus").after('<p class="text-danger">Group field is required</p>');
		...
		if(brandCode && brandName && brandStatus) {
			var form = $(this);
			// button loading
		...
		$.ajax({
			...
			success:function(response) {
				...
				$('#editBrandForm').unbind('submit').bind('submit', function() {
					...
					if(brandCode == "") {
						$("#editBrandCode").after('<p class="text-danger">Group field is required</p>');
						$('#editBrandCode').closest('.form-group').addClass('has-error');
					} else {
						// remov error text field
						$("#editBrandCode").find('.text-danger').remove();
						// success out for form 
						$("#editBrandCode").closest('.form-group').addClass('has-success');	  	
					}

					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">Group field is required</p>');
					...
					if(brandStatus == "") {
						$("#editBrandStatus").after('<p class="text-danger">Group field is required</p>');
